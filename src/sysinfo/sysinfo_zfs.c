...
sysinfo_zfs(nvlist_t *root_nvl)
{
	...
	nvlist_add_string(root_nvl, "Zpool", zpool);
	 ...
	 */
	nvlist_add_int32(root_nvl, "Zpool Creation",
	...
	nvlist_add_int32(root_nvl, "Zpool Size in GiB", size);
	...
	nvlist_add_string(root_nvl, "Zpool Disks", alldevices);
